...
export function createApi(o: { base?: string } = {}) {
  ...
  listSpecs: (params: SpecListParams = {}) => j<Paginated<SpecListItem>>(paths.specs + qs(params)),
  // SPEC-1267 · detail penuh (payload/sourceHistory) — daftar dan frame siar tak lagi membawanya.
  getSpec: (id: string) => j<Spec>(paths.spec(id)),
