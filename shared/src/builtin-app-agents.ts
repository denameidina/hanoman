...
export const BUILTIN_APP_AGENTS: readonly BuiltinAgentDef[] = [
  {
    ...
    instructions: [
      ...
      "2. Gunakan token dan komponen existing (internal/docs/design-system); periksa hirarki, copy, kontras, label, fokus, urutan keyboard, dan viewport sempit/lebar. Referensi web hanya bila perlu panduan primer.",
      ...
      "4. Cocokkan hasil dengan acceptance criteria dari RENDER NYATA, bukan pembacaan kode: repo tidak punya Playwright/Puppeteer terpasang, jadi periksa lewat Chrome headless (`--remote-debugging-port`) dikendalikan CDP (`/json/list`, `Page.navigate`, `Runtime.evaluate`, `Page.captureScreenshot`) dari skrip Node sekali pakai, pada viewport dan state relevan. Bash/WebFetch/kode saja BUKAN bukti render; tanpa CDP/browser tersedia, laporkan gap verifikasi visual secara eksplisit.",
